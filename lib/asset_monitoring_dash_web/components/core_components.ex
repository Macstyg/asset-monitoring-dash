defmodule AssetMonitoringDashWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AssetMonitoringDashWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AssetMonitoringDashWeb.Gettext, "errors", msg, opts)
    end
  end
